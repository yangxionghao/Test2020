...
<td colspan=2 width="33.4%"><input type="text" class="form-control" id="jgmc" name="jgmc" value=${wj.jgmc}></td>
<td colspan=1><label>归口管理部门</label></td>
<td colspan=2 width="33.4%"><input type="text" class="form-control" id="gkglbm" name="gkglbm" value=${wj.gkglbm}></td>
</tr>

<tr>
<td  colspan=1><label>通讯地址</label></td>
<td colspan=2 width="33.4%"><input type="text" class="form-control" id="txdz" name="txdz" value=${wj.txdz}></td>
<td  colspan=1><label>所在地域</label></td>
<td colspan=2 width="33.4%"><input type="text" class="form-control" id="szdy" name="txdz" value=${wj.szdy}></td>
</tr>

<tr>
<td  colspan=1><label>网址</label></td>
<td colspan=2 width="33.4%"><input type="text" class="form-control" id="dwwz" name="dwwz" value=${wj.dwwz}></td>
<td  colspan=1><label>电子邮箱</label></td>
<td colspan=2><input type="text" class="form-control" id="dzyx" name="dzyx" value=${wj.dzyx}></td>
</tr>

<tr>
<td  colspan=1><label>法人代表</label></td>
<td colspan=2 width="33.4%"><input type="text" class="form-control" id="frdb" name="frdb" value=${wj.frdb}></td>
<td  colspan=1><label>邮政编码</label></td>
<td colspan=2><input type="text" class="form-control" id="yzbm" name="yzbm" value=${wj.yzbm}></td>
</tr>

<tr >
<td rowspan=2  colspan=1><label>联系人</label></td>
<td rowspan=2  colspan=1 width="16.6%" style="text-align: center"><input type="text" class="form-control" id="lxr" name="lxr" value=${wj.lxr}></td>
<td  colspan=1><label>电话</label></td>
<td colspan=3>
<div class="col-md-4" width="50%"><input type="text" class="form-control" id="gddh" name="gddh" placeholder="固定电话" value=${wj.gddh}></div>
&nbsp;&nbsp;  <div class="col-md-4" width="50%"><input type="text" class="form-control" id="yddh" name="yddh" placeholder="手机" value=${wj.yddh}></div>
</td>
</tr>

<tr>
<td  colspan=1><label>传真</label></td>
<td colspan=3><input type="text" class="form-control" id="cz" name="cz" value=${wj.cz}></td>
</tr>
...
<textarea class="form-control" rows="5" id="jgjj" name="jgjj" >${wj.jgjj}</textarea>
<label><span id="num">0</span>/500</label></td>
</tr>

<tr>
<td  colspan=1><label>技术需求名称</label></td>
<td colspan=2><input type="text" class="form-control" id="jsxqmc" name="jsxqmc" value=${wj.jsxqmc}></td>
<td  colspan=1><label>需求年限</label></td>
<td colspan=2><div class="col-md-4" width="50%"><input type="text" class="form-control" id="qsnf" name="qsxqnf" placeholder="起始需求年份" value=${wj.qsxqnf}></div>
&nbsp;&nbsp;  <div class="col-md-4" width="50%"><input type="text" class="form-control" id="jznf" name="jzxqnf" placeholder="截至需求年份" value=${wj.jzxqnf}></div>
</td>
</tr>
...
<tr>
<td  colspan=6>
<textarea class="form-control" rows="5" id="jxqgs" name="jxqgs" >${wj.jxqgs}</textarea>
<div style="text-align: center;"><label><span id="num1">0</span>/500</label></div>
<br>
<label>关键字</label>
<div class="row">
  <div class="col-md-1" style="width: 20%"><input type="text" class="form-control" oninput="cx()" id="gjz1" name="gjz1" value=${wj.gjz1}></div>
  <div class="col-md-1" style="width: 20%"><input type="text" class="form-control" oninput="cx()" id="gjz2" name="gjz2" disabled="disabled" value=${wj.gjz2}></div>
  <div class="col-md-1" style="width: 20%"><input type="text" class="form-control" oninput="cx()" id="gjz3" name="gjz3" disabled="disabled" value=${wj.gjz3}></div>
  <div class="col-md-1" style="width: 20%"><input type="text" class="form-control" oninput="cx()" id="gjz4" name="gjz4" disabled="disabled" value=${wj.gjz4}></div>
  <div class="col-md-1" style="width: 20%"><input type="text" class="form-control" oninput="cx()" id="gjz5" name="gjz5" disabled="disabled" value=${wj.gjz5}></div>
</div>
</td>
</tr>
...
<td colspan=2 width="33.4%"><input type="text" class="form-control" id="ntrzjze" name="ntrzjze" placeholder="万元" value=${wj.ntrzjze}></td>
<td  colspan=3>&nbsp;</td>
</tr>
...
<tr>
<td colspan=5><label>合作意向单位</label><input type="text" id="hzyxdw" name="hzyxdw" class="form-control" value=${wj.hzyxdw} }></td>
</tr>
...
<td colspan=6>
<a href="${pageContext.request.contextPath}//xssh_ty?wjid=${wj.wjid}"><input type="button" value="通过" class="btn btn-default" ></a>&nbsp;&nbsp; <input type="submit" value="不通过" class="btn btn-default" onclick="bty()"> 
</td>
</tr>


</table>
<form action="${pageContext.request.contextPath}//xssh_bty" method="post">
<table id ="tabl"  class="table table-bordered">
	...
	function bty(){
		var wjid = "${wj.wjid}";
		var str = "";
		str = str + "<tr><td colspan='6'><label>" + "提交部门：" +"</label></td></tr><tr><td colspan='6'><select name='glcs' class='form-control' style='width:200px'>" 
		...
		+"</select></td></tr>";
		str = str + "<tr><td colspan='6'><label>" + "审核意见：" +"</label></td></tr><tr><td colspan='6'><textarea class='form-control' rows='5' id='shyj' name='shyj' >" +"</textarea></td></tr>";
		str = str + "<tr><td colspan='6'><input type='submit' value='确定' class='btn btn-default' ></td></tr>";
		str = str + "<tr><td><input type='text' value='"+wjid+"' style='display:none' name='wjid'></td></tr>"
		$("#tabl").append(str);
	}
