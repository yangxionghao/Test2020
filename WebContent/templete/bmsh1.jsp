...
<td colspan=6>
<a href="${pageContext.request.contextPath}/bmsh_ty?wjid=${wj.wjid}"><input type="button" value="通过" class="btn btn-default" ></a>&nbsp;&nbsp; <input type="submit" value="不通过" class="btn btn-default" onclick="bty()"> 
</td>
</tr>


</table>
<form action="${pageContext.request.contextPath}/bmsh_bty" method="post">
